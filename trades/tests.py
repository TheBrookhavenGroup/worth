...
def make_trades():
    ...
    dt = our_localize(
        datetime.datetime(year=2021, month=10, day=22, hour=10, minute=0, second=0)
    )
    Trade.objects.create(dt=dt, account=a, ticker=t, q=100, p=300, reinvest=False)
    dt = our_localize(
        datetime.datetime(year=2021, month=10, day=25, hour=11, minute=0, second=0)
    )
    ...
    dt = our_localize(
        datetime.datetime(year=2021, month=10, day=22, hour=10, minute=30, second=0)
    )
    ...
    dt = our_localize(
        datetime.datetime(year=2017, month=1, day=19, hour=16, minute=15, second=0)
    )
    Trade.objects.create(dt=dt, account=a, ticker=t, q=1000, p=29.01, reinvest=False)
    dt = our_localize(
        datetime.datetime(year=2017, month=12, day=15, hour=16, minute=15, second=0)
    )
    ...
    dt = our_localize(
        datetime.datetime(year=2021, month=10, day=22, hour=12, minute=30, second=0)
    )
    Trade.objects.create(dt=dt, account=a, ticker=t, q=2, p=4500.00, reinvest=False)
    dt = our_localize(
        datetime.datetime(year=2021, month=10, day=22, hour=13, minute=0, second=0)
    )
...
def make_trades_split():
    ...
    for y, m, d, q, p, reinvest, note in [
        (2020, 5, 8, 50, 305.0, False, None),
        (2020, 8, 31, 150, 0.00, True, "Split 4:1"),
        (2020, 8, 31, -100, 200.00, False, None),
    ]:
        dt = our_localize(
            datetime.datetime(year=y, month=m, day=d, hour=10, minute=0, second=0)
        )
        Trade.objects.create(
            dt=dt, account=a, ticker=aapl_ticker, q=q, p=p, reinvest=reinvest, note=note
        )
    ...
    for y, m, d, q, p, reinvest, note in [
        ...
        Trade.objects.create(
            dt=dt, account=a, ticker=msft_ticker, q=q, p=p, reinvest=reinvest, note=note
        )
...
def make_lifo_trades():
    fidelity = Account.objects.create(
        name="Fidelity",
        owner="MS",
        broker="Fidelity",
        broker_account="123",
    ...
    t = aapl
    dt = our_localize(
        datetime.datetime(year=2020, month=3, day=22, hour=10, minute=0, second=0)
    )
    Trade.objects.create(dt=dt, account=a, ticker=t, q=100, p=300, reinvest=False)
    dt = our_localize(
        datetime.datetime(year=2020, month=4, day=25, hour=11, minute=0, second=0)
    )
    Trade.objects.create(dt=dt, account=a, ticker=t, q=-100, p=301, reinvest=False)
    ...
    dt = our_localize(
        datetime.datetime(year=2021, month=10, day=26, hour=11, minute=0, second=0)
    )
    Trade.objects.create(dt=dt, account=a, ticker=t, q=10, p=306, reinvest=False)
    dt = our_localize(
        datetime.datetime(year=2022, month=1, day=6, hour=11, minute=0, second=0)
    )
    Trade.objects.create(dt=dt, account=a, ticker=t, q=10, p=307, reinvest=False)
    dt = our_localize(
        datetime.datetime(year=2022, month=2, day=6, hour=11, minute=0, second=0)
    )
    Trade.objects.create(dt=dt, account=a, ticker=t, q=-20, p=315, reinvest=False)
    dt = our_localize(
        datetime.datetime(year=2022, month=3, day=6, hour=11, minute=0, second=0)
    )
    Trade.objects.create(dt=dt, account=a, ticker=t, q=10, p=310, reinvest=False)

    t = amzn
    dt = our_localize(
        datetime.datetime(year=2021, month=10, day=20, hour=10, minute=30, second=0)
    )
    Trade.objects.create(dt=dt, account=a, ticker=t, q=100, p=100, reinvest=False)
    dt = our_localize(
        datetime.datetime(year=2022, month=4, day=20, hour=10, minute=30, second=0)
    )
    ...
    t = aapl
    dt = our_localize(
        datetime.datetime(year=2021, month=6, day=22, hour=10, minute=0, second=0)
    )
    Trade.objects.create(dt=dt, account=a, ticker=t, q=100, p=300, reinvest=False)
    dt = our_localize(
        datetime.datetime(year=2021, month=7, day=25, hour=11, minute=0, second=0)
    )
    Trade.objects.create(dt=dt, account=a, ticker=t, q=-50, p=301, reinvest=False)
    dt = our_localize(
        datetime.datetime(year=2022, month=8, day=6, hour=11, minute=0, second=0)
    )
    Trade.objects.create(dt=dt, account=a, ticker=t, q=-10, p=310, reinvest=False)

    t = msft
    dt = our_localize(
        datetime.datetime(year=2021, month=3, day=12, hour=10, minute=0, second=0)
    )
    Trade.objects.create(dt=dt, account=a, ticker=t, q=20, p=300, reinvest=False)
    dt = our_localize(
        datetime.datetime(year=2021, month=9, day=25, hour=11, minute=0, second=0)
    )
    Trade.objects.create(dt=dt, account=a, ticker=t, q=-20, p=300, reinvest=False)
