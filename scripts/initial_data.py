...
from tbgutils.dt import yyyymmdd2dt
...
def cash_balance(account):
    ...
    qs = Trade.objects.filter(account__name=account).values_list(
        "reinvest", "q", "p", "commission"
    )
